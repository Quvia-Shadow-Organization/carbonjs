namespace HTTP {
    ...
    export class Client {
        ...
        async get(relativeUrl: string): Promise<Response> {
            return await HTTP.get(this.headers, this.urlif(relativeUrl));
        }
        async del(relativeUrl: string): Promise<Response> {
            return await HTTP.del(this.headers, this.urlif(relativeUrl));
        }
        async post(relativeUrl: string, data: any): Promise<Response> {
            return await HTTP.post(this.headers, this.urlif(relativeUrl), data);
        }
        async put(relativeUrl: string, data: any): Promise<Response> {
            return await HTTP.put(this.headers, this.urlif(relativeUrl), data);
        }
        async patch(relativeUrl: string, data: any): Promise<Response> {
            return await HTTP.patch(this.headers, this.urlif(relativeUrl), data);
        }
    }
